...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\igualtiltilzeitor on
     Windows, /home/user/dev/igualtiltilzeitor on Linux) in a file named
     igualtiltilzeitor@gabriel.punisher.gilini and copy that file to
